<?php
	...
	function woocommerce_table_rate_menus() {
		...
		$shipping_zones_page = add_submenu_page( 'woocommerce', __('Shipping Zones', 'wc_table_rate'),  __('Shipping Zones', 'wc_table_rate') , 'manage_woocommerce', 'shipping_zones', 'woocommerce_shipping_zones_page');
	...
	function woocommerce_shipping_zones_css() {
		...
		wp_enqueue_style( 'woocommerce_shipping_zone_admin_styles', plugins_url( '/assets/css/admin.css', dirname( __FILE__ ) ) );
	}
