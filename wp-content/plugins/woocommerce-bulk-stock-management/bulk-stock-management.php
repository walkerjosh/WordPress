 ...
 **/
if (is_admin()) {
	$woo_plugin_updater_advanced_stock_management = new WooThemes_Plugin_Updater( __FILE__ );
	$woo_plugin_updater_advanced_stock_management->api_key = 'a7ef7b6f8d2561da04f15e6bdbefd4d9';
	$woo_plugin_updater_advanced_stock_management->init();
}
