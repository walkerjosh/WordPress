 ...
 **/
if (is_admin()) {
	$woo_plugin_updater_followup = new WooThemes_Plugin_Updater( __FILE__ );
	$woo_plugin_updater_followup->api_key = 'd9a0a78be9531a14617a862d08ecb047';
	$woo_plugin_updater_followup->init();
}
        ...
        function settings() {
            ...
            if ($tab == 'list') {
                ...
                if ($email->product_id != 0) {
                    $product = new WC_Product($email->product_id);
                }
