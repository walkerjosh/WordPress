...
class FUE_Reports {
    ...
    public function init() {
        ...
        // sending
        add_filter('fue_email_message', array(&$this, 'email_message'), 10, 2);
    ...
    public function settings_tab($tab = '') {
        $tabs   = array('reports', 'reportview', 'reportuser_view', 'emailopen_view', 'linkclick_view');
        ...
        if (empty($coupon_reports)) {
            ...
            foreach ($coupon_reports as $report) {
                ...
                if ( $report->coupon_used == 1 ) {
                    $date = date('M d, Y h:i A', strtotime($report->date_used));
                ...
                <tr scope="row">
                    ...
                    <td>'. $used .'</td>
                    <td>'. date('M d,Y h:i A', strtotime($report->date_sent)) .'</td>
                </tr>
                ';
            }
        }
        ...
        if (empty($exclude_reports)) {
            ...
            foreach ($exclude_reports as $report) {
                ...
                <tr scope="row">
                    ...
                    <td>'. date('M d,Y h:i A', strtotime($report->date_added)) .'</td>
                </tr>
                ';
            }
        }
    ...
    <div class="subsubsub_section">
            ...
            <table class="wp-list-table widefat fixed posts">
                <thead>
                    <tr>
                        ...
                        <th scope="col" id="usage_count" class="manage-column column-usage_count" style="">'. __('Emails Sent', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The number of individual emails sent using this follow-up email', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="opened" class="manage-column column-usage_count" style="">'. __('Emails Opened', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The number of times the this specific follow-up emails has been opened', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="clicked" class="manage-column column-usage_count" style="">'. __('Links Clicked', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The number of times links in this follow-up email have been clicked', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                    </tr>
                </thead>
                <tbody id="the_list">
                    '. $emails_block .'
            ...
            <table class="wp-list-table widefat fixed posts">
                <thead>
                    <tr>
                        ...
                        <th scope="col" id="coupon_code" class="manage-column column-usage_count" style="">'. __('Coupon Code', 'wc_followup_emails') .' <img class="help_tip" title="'. __('This is the unique coupon code generated by the follow-up email for this specific email address', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="email_name" class="manage-column column-usage_count" style="">'. __('Email Name', 'wc_followup_emails') .' <img class="help_tip" title="'. __('This is the name of the follow-up email that generated the coupon that was sent to this specific email address', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="used" class="manage-column column-used '. $used_class .' '. $used_sort .'" style="">
                            <a href="admin.php?page=wc-followup-emails&tab=reports&sortby=coupon_used&sort='. $used_dir .'&v=coupons">
                                <span>'. __('Used', 'wc_followup_emails') .'  <img class="help_tip" title="'. __('This tells you if this specific coupon code generated and sent via follow-up emails has been used, and if it has, it includes the date and time', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></span>
                                <span class="sorting-indicator"></span>
                            </a>
                        </th>
                        <th scope="col" id="date_sent" class="manage-column column-date_sent '. $sent_class .' '. $sent_sort .'" style="">
                            <a href="admin.php?page=wc-followup-emails&tab=reports&sortby=date_sent&sort='. $sent_dir .'&v=coupons">
                                <span>'. __('Date Sent', 'wc_followup_emails') .' <img class="help_tip" title="'. __('This is the date and time that this specific coupon code was sent to this email address', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></span>
                                <span class="sorting-indicator"></span>
                            </a>
                        </th>
                    </tr>
        ...
        <div class="section" id="excludes">
            ...
            <table class="wp-list-table widefat fixed posts">
                <thead>
                    <tr>
                        <th scope="col" id="coupon_name" class="manage-column column-type" style="">'. __('Email Name', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The name of the follow-up email that a customer has opted out of', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="coupon_name" class="manage-column column-type" style="">'. __('Email Address', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The email address of the customer that opted out', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                        <th scope="col" id="coupon_name" class="manage-column column-type" style="">'. __('Date', 'wc_followup_emails') .' <img class="help_tip" title="'. __('The date and time that the email address was opted out this follow-up email', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></th>
                    </tr>
                </thead>
                <tbody id="the_list">
                    '. $excludes_block .'
    ...
    public static function get_reports( $args = array() ) {
        ...
        if ( $args['type'] == 'emails' ) {
            if ( empty($args['id']) ) {
                return $wpdb->get_results( "SELECT email_id, email_name, COUNT( email_name ) AS sent FROM  `{$wpdb->prefix}followup_email_logs` GROUP BY email_id ORDER BY date_sent DESC" );
            } else {
