...
class FUE_Coupons{
    ...
    public static function generateCouponCode() {
        ...
        do {
            ...
            $check = $wpdb->get_var("SELECT COUNT(*) FROM `{$wpdb->prefix}posts` WHERE `post_title` = '". $wpdb->escape($code) ."' AND `post_type` = 'shop_coupon'");
    ...
    public function form_before_message($defaults = array()) {
        ...
        <tr valign="top" class="class_coupon">
            <th scope="row">
    ...
    public function form_variables() {
        global $woocommerce;
        echo '<li class="class_coupon"><strong>{coupon_code}</strong> <img class="help_tip" title="'. __('Coupon code generated', 'wc_followup_emails') .'" src="'. $woocommerce->plugin_url() .'/assets/images/help.png" /></li>';
    }
                                    ...
                                    <div id="coupon_options" class="panel woocommerce_options_panel">
                                        ...
                                        <div class="options_group">
                                            <p class="form-field">
                                                ...
                                                <img class="help_tip" src="<?php echo plugins_url(); ?>/woocommerce/assets/images/help.png" data-tip="Products which need to be in the cart to use this coupon or, for &quot;Product Discounts&quot;, which products are discounted.">
                                            </p>
                                            <p class="form-field">
                                                ...
                                                <img class="help_tip" src="<?php echo plugins_url(); ?>/woocommerce/assets/images/help.png" data-tip='Products which must not be in the cart to use this coupon or, for "Product Discounts", which products are not discounted.'>
                                            </p>
                                        </div>
                                        <div class="options_group">
                                            <p class="form-field">
                                                ...
                                                <img class="help_tip" src="<?php echo plugins_url(); ?>/woocommerce/assets/images/help.png" data-tip='A product must be in this category for the coupon to remain valid or, for "Product Discounts", products in these categories will be discounted.'>
                                            </p>
                                            <p class="form-field">
                                                ...
                                                <img class="help_tip" src="<?php echo plugins_url(); ?>/woocommerce/assets/images/help.png" data-tip='Product must not be in this category for the coupon to remain valid or, for "Product Discounts", products in these categories will not be discounted.'>
                                            </p>
                                        </div>
                                        <div class="options_group">
                                            <p class="form-field">
