...
?>
    <form action="admin-post.php" method="post" id="sfn_form">
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr valign="top" class="always_send_tr hideable <?php do_action('fue_form_always_send_tr_class', $defaults); ?>">
                ...
                <tr valign="top" class="interval_tr hideable">
                    ...
                    <td class="interval_td">
                        ...
                        <span class="show-if-date interval_date_span hideable">
                            <input type="text" name="send_date" class="date" readonly value="<?php echo esc_attr($defaults['send_date']); ?>" />
                        </span>
                    </td>
                </tr>
                ...
                <tr valign="top" class="non-generic non-signup hideable <?php do_action('fue_form_product_description_tr_class', $defaults); ?> product_description_tr">
                    ...
                    <strong><?php _e('Select the product that, when bought or added to the cart, will trigger this follow-up email.', 'wc_review_discount'); ?></strong>
                    </th>
                </tr>
                    ...
                    <th scope="row">
                        ...
                        <span class="description">
                            ...
                            <ul>
                                ...
                                <li class="var hideable var_customer_first_name"><strong>{customer_first_name}</strong> <img class="help_tip" title="<?php _e('The first name of the customer who purchased from your store.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_customer_name"><strong>{customer_name}</strong> <img class="help_tip" title="<?php _e('The full name of the customer who purchased from your store.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_store_url"><strong>{store_url}</strong> <img class="help_tip" title="<?php _e('The URL/Address of your store.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_store_name"><strong>{store_name}</strong> <img class="help_tip" title="<?php _e('The name of your store.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_item_name non-generic non-signup"><strong>{item_name}</strong> <img class="help_tip" title="<?php _e('The name of the purchased item.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_item_category non-generic non-signup"><strong>{item_category}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased item is under.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_item_names generic non-signup"><strong>{item_names}</strong> <img class="help_tip" title="<?php _e('Displays a list of purchased items.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_item_categories generic non-signup"><strong>{item_categories}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased items are under.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_order_number not-cart non-signup"><strong>{order_number}</strong> <img class="help_tip" title="<?php _e('The generated Order Number for the puchase', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_order_datetime not-cart non-signup"><strong>{order_datetime}</strong> <img class="help_tip" title="<?php _e('The date and time that the order was made', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                                <li class="var hideable var_unsubscribe_url"><strong>{unsubscribe_url}</strong> <img class="help_tip" title="<?php _e('URL where users will be able to opt-out of the email list.', 'wc_followup_emails'); ?>" src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png" /></li>
                            </ul>
                        </span>
                    </th>
                    <td>
        ...
        <p class="submit">
            ...
            <input type="submit" id="save" name="save" value="<?php _e('Create Follow-Up Email', 'wc_followup_emails'); ?>" class="button-primary" />
        </p>
    </form>
    ...
    jQuery(document).ready(function() {
        ...
        if (jQuery("#tracking_on").attr("checked")) {
            jQuery(".tracking_on").show();
        } else {
            jQuery(".tracking_on").hide();
        }
        ...
        jQuery("#sfn_form").submit(function(e) {
            if (sfn_checked == false) {
                ...
                jQuery.post(ajaxurl, data, function(resp) {
                    ...
                    jQuery("#save")
                        .val("<?php _e('Create Follow-Up Email', 'wc_followup_emails'); ?>")
                        .attr("disabled", false)
                });
                return false;
            }
