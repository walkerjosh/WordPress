...
class WC_Advanced_Notifications {
	...
	function get_notifcations_for_order( $order ) {
		...
		foreach( $order->get_items() as $item ) {
			...
			// Cats
			$product_cats = array_merge( $product_cats, wp_get_post_terms( $item['id'], 'product_cat', array( "fields" => "ids" ) ) );
		}
...
$GLOBAL['wc_advanced_notifications'] = new WC_Advanced_Notifications();