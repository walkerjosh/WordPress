<?php
/*
Template Name: Portfolio - 4 col wide
A four columnar portfolio on full width */
...
<div id="content" class="full-width" role="main">
    ...
    if (is_page() ) {
		...
		$post_per_page = empty($page_opts['post_per_page']) ? '12' : $page_opts['post_per_page'];
		if( have_posts() ):
    ...
    if ($category) {
		...
		<ul class="port col4-wide clearfix">
