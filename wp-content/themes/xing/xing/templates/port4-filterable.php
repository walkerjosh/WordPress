<?php
/*
Template Name: Portfolio Filterable - 4 col wide
A four columnar filterable portfolio on full width */
...
<div id="content" class="full-width" role="main" >
    ...
    if ($category) {
		...
		$count = 1; ?>
		<ul class="port ss_filterable col4-wide clearfix">
		<?php while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				<?php $count++;
            endwhile; ?>
		</ul><!-- .port .ss_filterable .col4-wide -->
		<?php else : ?>
