<?php
/*
Template Name: Portfolio Filterable - 4 col with SB
A four columnar filterable portfolio with sidebar */
...
<div id="content" <?php if ( $xng_sb_pos == 'left' ) echo (' class="content-right"'); ?> role="main">
    ...
    if ($category) {
		...
		if( $wp_query->have_posts() ) :
			$count = 1; ?>
			<ul class="port ss_filterable col4 clearfix">
