<?php
/*
Template Name: Portfolio Filterable - 5 col wide
A five columnar filterable portfolio on full width */
...
<div id="content" class="full-width" role="main">
    ...
    if ($category) {
		...
		if( $wp_query->have_posts() ) :
			$count = 1; ?>
			<ul class="port ss_filterable col5-wide clearfix">
			<?php while ($wp_query->have_posts()) : $wp_query->the_post();
					...
					<?php $count++;
                endwhile; ?>
			</ul><!-- .port .ss_filterable .col5-wide -->
		<?php else : ?>
